...
from pefts import get_model, get_tokenizer
...
from utils import (
    generate_inference,
    printd,
    extend_position_embeddings_simple,
    freeze_roberta_position_embeddings
)
...
if __name__ == "__main__":
    ...
    model, tokenizer = extend_position_embeddings_simple(model, tokenizer, new_max_position=1026)
    model.to(device)

    print(model)

    model = freeze_roberta_position_embeddings(model)
